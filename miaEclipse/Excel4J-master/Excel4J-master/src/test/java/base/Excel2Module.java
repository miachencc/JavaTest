...
public class Excel2Module {
    ...
    public void excel2Object() throws Exception {
        ...
        String path = "D:\\GIT\\JavaTest\\JavaTest\\miaEclipse\\Excel4J-master\\Excel4J-master\\src\\test\\resources\\Feedback-HSS.xlsx";

        System.out.println("读取全部：");
        List<Feedback> students = ExcelUtils.getInstance().readExcel2Objects(path, Feedback.class);
        for (Feedback stu : students) {
...
//
//        String path = "D:\\GIT\\JavaTest\\JavaTest\\miaEclipse\\Excel4J-master\\Excel4J-master\\src\\test\\resources\\students_02.xlsx";
//        try {
//
//            // 1)
