...
<html>
    ...
    <form action="/CServlet" method="post" >
        ...
        <input type = "text" placeholder="pls enter username" style = "height:25px;width:150px;" name="username"/><br />
        <label style="margin-left:20px">password</label>
        <input type = "text" placeholder="pls enter password" style = "height:25px;width:150px;" name="password"/><br />
        <input type = "submit" value="login" style = "height:25px;wdith:150px;margin-left:20px">
    </form>
			<!-- 引入header.jsp -->
